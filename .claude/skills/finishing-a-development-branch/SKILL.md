...
<Good>
```
Command failed: "git merge feature-branch" - merge conflicts

Investigation:
- Checked branches involved
- Root cause: Diverged history with conflicting changes

Fix: Ask user how to resolve conflicts (don't just retry)
```
</Good>
