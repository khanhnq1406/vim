...
<Good>
```
Suggestion implementation failed: Tests not passing

Investigation:
- Read the review feedback carefully
- Root cause: Feedback was unclear about expected behavior

Fix: Ask reviewer for clarification before retrying implementation
```
</Good>

<Bad>
```
Implementation failed tests
Retrying with same approach... failed
Retrying... failed
```
</Bad>
