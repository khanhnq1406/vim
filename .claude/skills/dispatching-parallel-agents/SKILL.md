...
<Good>
```
Agent failed: Task timeout after 30 seconds

Investigation:
- Agent was dispatched to fix large test file
- Root cause: Task scope too broad for timeout

Fix: Split into smaller, focused agent tasks
```
</Good>
...
Retrying with same task... timeout
Retrying with same task... timeout
```
</Bad>
