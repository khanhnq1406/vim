...
<Good>
```
Skill validation failed: Subagent didn't follow new skill

Investigation:
- Reviewed skill content
- Root cause: Instructions were ambiguous or conflicting

Fix: Clarify skill instructions, then retry validation
```
</Good>
