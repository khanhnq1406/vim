...
<Good>
```
Worktree creation failed: "git worktree add" - invalid path

Investigation:
- Checked target directory
- Root cause: Directory already contains non-git files

Fix: Choose different location or clean directory, then retry
```
</Good>
