...
<Good>
```
Test run failed: "npm test" - Unexpected test failure

Investigation:
- Read test output carefully
- Root cause: Test expects behavior that conflicts with implementation

Fix: Understand if test is wrong or implementation is wrong before re-running
```
</Good>
