...
<Good>
```
Code review dispatch failed: Subagent error

Investigation:
- Checked git SHAs
- Root cause: Invalid commit range (BASE_SHA after HEAD_SHA)

Fix: Correct the commit range, then retry review dispatch
```
</Good>
