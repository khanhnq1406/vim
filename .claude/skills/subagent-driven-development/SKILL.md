...
<Good>
```
Subagent task failed: Timeout after 30 seconds

Investigation:
- Subagent was working on complex task
- Root cause: Task scope too broad for single subagent call

Fix: Break into smaller subtasks, retry with focused scope
```
</Good>
...
Retrying with same prompt... timeout
Retrying... timeout
```
</Bad>
